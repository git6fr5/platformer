...
Shader "Basic/FlashShader"
{
    Properties
    {
        ...
        _FlashColor("Flash Color", Color) = (0,0,1,1)
        _FlashRate("Flash Rate", Float) = 6
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float4 f = _FlashColor;
                float4 fCol = col.a * f.a * f * round(0.5 + (sin(_Time[1] * UNITY_PI * _FlashRate)) * 0.5);
                ...
                float4 o = (col + mCol + aCol + fCol) * col.a;
                return o;
            }
            ENDCG
        }
